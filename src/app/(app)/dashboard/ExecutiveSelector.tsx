...
export default function ExecutiveSelector({
  ...
  return (
    <div className="flex items-center gap-1.5 bg-slate-100 p-1 rounded-lg border border-slate-200/80 text-xs font-semibold">
      <div className="flex items-center gap-1 pl-2 text-slate-500 text-[11px]">
      ...
      <select
        ...
        className="bg-white text-slate-800 text-xs font-semibold px-2.5 py-1 rounded-md border border-slate-200/70 shadow-2xs focus:outline-hidden cursor-pointer"
